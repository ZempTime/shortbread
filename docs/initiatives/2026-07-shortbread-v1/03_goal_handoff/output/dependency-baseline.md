...
- **Tool security fixes:** Aube is pinned to `1.29.1`, whose [release](https://github.com/jdx/aube/releases/tag/v1.29.1) fixes the security-relevant `minimumReleaseAge` behavior. AnyCable Go remains at `1.6.15`, which is outside the affected range for [GHSA-w72w-9qmj-c9qm](https://github.com/advisories/GHSA-w72w-9qmj-c9qm) and [GHSA-5p54-whvp-x327](https://github.com/advisories/GHSA-5p54-whvp-x327).
